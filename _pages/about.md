...
the Rayleigh-Sommerfeld diffraction formula for scaled cylindrical holography, in which the object’s
height can be adjusted. Then, a method of fast scaled cylindrical diffraction is presented by scaled
convolution based on scaled Fourier Transform, and it significantly reduces computational time,
enhancing its practical feasibility. Furthermore, the proposed method is extended to 3D objects using
a layer-oriented approach. Moreover, the effectiveness and feasibility of the proposed method are
